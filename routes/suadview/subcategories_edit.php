            ...
            <div class="content">
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <? if (empty($id)) { ?>
                            <h3 class="block-title">Añadir subcategoría</h3>
                        <? } else { ?>
                            <h3 class="block-title">Editar subcategoría</h3>
                        <? } ?>
                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-8">
                                <form id="category" method="POST" data-action="<? if (!empty($id)) echo "edit";
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label" for="dm-ecom-category-type">Categoría</label>
                                        <select class="form-select" name="category-type" id="dm-ecom-category-type" required>
