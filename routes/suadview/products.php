...
<body>
            ...
            <div class="content">
                ...
                <div class="row items-push">
                    ...
                    <div class="col-6 col-lg-3">
                        <a
                            ...
                            <div class="block-content py-5">
                                <div class="fs-3 fw-semibold text-danger mb-1" id="allProd"></div>
                    ...
                    <div class="col-6 col-lg-3">
                        <a
                            ...
                            href="javascript:void(0)">
                            <div class="block-content py-5">
                                <div class="fs-3 fw-semibold text-dark mb-1" id="visits"></div>
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Todos los productos</h3>
                    ...
                    <div class="block-content">
                            ...
                            <table
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Categoria</th>
                                        <th class="d-none d-sm-table-cell text-end">Precio</th>
                                        <th class="d-none d-sm-table-cell text-center">Descuento</th>
                                        <th class="d-none d-sm-table-cell text-center">% descuento</th>
                                        <th class="d-none d-sm-table-cell text-center">Vistas</th>
                        ...
                        <nav aria-label="Pagination">
                            <ul class="pagination justify-content-end mt-2">
                                <!-- Paginación dinámica se insertará aquí -->
                            </ul>
                        </nav>
                        <!-- END Pagination -->
                    </div>
    ...
    <script>
        ...
        function actualizarPaginacion(totalPaginas, paginaActual) {
            ...
            document.querySelectorAll(".pagination a").forEach((link) => {
                link.addEventListener("click", function() {
                    let pagina = parseInt(this.dataset.pagina);
                    loadProducts(pagina);
                });
            });
        }
        ...
        async function loadProducts(page = 1) {
            try {
                const response = await fetch(`/src/api/products/read_products.php?pagina=${page}`);
                ...
                if (result.status === "success") {
                    ...
                    <td class="d-none d-sm-table-cell text-center fs-sm">
                        ${product.descuento == 0 ? "Sin descuento" : "Con descuento"}
                    </td>
                    <td class="d-none d-sm-table-cell text-center fs-sm">
                        ${product.porcentajeD}%
                    </td>
                    ...
                    <td class="text-center fs-sm">
                        <a class="btn btn-sm btn-alt-secondary edit-btn" data-id="${product.id}" data-name="${product.nombre}" href="javascript:void(0)">
                ...
                `;
                    ...
                    // Mostrar visitas y añadir eventos después de cargar productos
                    showVisits();
                    attachEventListeners();

                    // Actualizar paginación
                    actualizarPaginacion(result.totalPaginas, result.paginaActual);
                } else {
            ...
            document.querySelectorAll(".edit-btn").forEach(button => {
                button.addEventListener("click", function() {
                    ...
                    if (confirm("¿Estás seguro de que deseas editar este producto?")) {
                        window.location.href = `/routes/suadview/products_edit.php?id=${id}`;
                    }
                });
            });
        ...
        async function deleteProduct(id) {
            try {
                const response = await fetch("/src/api/products/delete_product.php", {
                    method: "POST",
                    headers: {
        ...
        async function showVisits() {
            ...
            try {
                const response = await fetch("/src/api/products/all_views_product.php");

                const result = await response.json();
                visits.textContent = result.data[0]["SUM(visitas)"] > 0 ? result.data[0]["SUM(visitas)"] : 0;
                allProd.textContent = result.data[0]["COUNT(id)"] > 0 ? result.data[0]["COUNT(id)"] : 0;
            } catch (error) {
                console.error("Error al mostrar visitas el producto:", error);
            }
        }
