...
<body>
    ...
    <script>
        async function loadCategories() {
            try {
                const response = await fetch("/src/api/subcategories/read_subcategories.php");
            ...
            document.querySelectorAll(".edit-btn").forEach(button => {
                button.addEventListener("click", function() {
                    ...
                    if (confirm("¿Estás seguro de que deseas editar esta categoría?")) {
                        window.location.href = `/routes/suadview/subcategories_edit.php?id=${id}`;
                    }
                });
            });
        ...
        async function deleteCategory(id) {
            try {
                const response = await fetch("/src/api/subcategories/delete_subcategory.php", {
                    method: "POST",
                    headers: {
        ...
        async function showCategory(id) {
            ...
            try {
                const response = await fetch("/src/api/subcategories/all_views_subcategory.php");
