...
<head>
    ...
    <title>Piel Canela | Subcategorias</title>
...
<body>
            ...
            <div class="content">
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Todas las subcategorías</h3>
                    </div>
                            ...
                            <table
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="d-none d-md-table-cell">Categoría principal</th>
    ...
    <script>
        async function loadCategories() {
            try {
                const response = await fetch(`${BASE_URL}src/api/subcategories/read_subcategories.php");
                ...
                if (result.status === "success") {
                    ...
                    <td class="d-none d-md-table-cell fs-sm">
                        <a class="fw-semibold" href="javascript:void(0)">${category.c_nombre}</a>
                    </td>
                    <td class="text-center fs-sm">
            ...
            document.querySelectorAll(".edit-btn").forEach(button => {
                button.addEventListener("click", function() {
                    ...
                    if (confirm("¿Estás seguro de que deseas editar esta categoría?")) {
                        window.location.href = `${BASE_URL}routes/suadview/subcategories_edit.php?id=${id}`;
                    }
                });
            });
        ...
        async function deleteCategory(id) {
            try {
                const response = await fetch(`${BASE_URL}src/api/subcategories/delete_subcategory.php", {
                    method: "POST",
                    headers: {
        ...
        async function showCategory(id) {
            ...
            try {
                const response = await fetch(`${BASE_URL}src/api/subcategories/all_views_subcategory.php");
