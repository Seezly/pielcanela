            ...
            <div class="content">
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Todos los usuarios</h3>
                            ...
                            <table
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="d-none d-md-table-cell">Privilegios</th>
                                        <th class="d-none d-sm-table-cell text-end">Usuario</th>
            ...
            try {
                ...
                if (result.status === "success") {
                    ...
                    <td class="d-none d-md-table-cell fs-sm">
                        <a
                            class="fw-semibold"
                            href="javascript:void(0)">${user.nombre}</a>
                    </td>
                    ...
                    <td class="text-center fs-sm">
                        <a class="btn btn-sm btn-alt-secondary edit-btn" data-id="${user.id}" data-name="${user.nombre}" href="javascript:void(0)">
                            <i class="fa fa-fw fa-eye"></i>
                        </a>
                        <a class="btn btn-sm btn-alt-secondary delete-btn" data-id="${user.id}" href="javascript:void(0)">
                            <i class="fa fa-fw fa-times text-danger"></i>
                        </a>
                    </td>
                `;
        ...
        function attachEventListeners() {
            ...
            document.querySelectorAll(".delete-btn").forEach(button => {
                button.addEventListener("click", async function() {
                    ...
                    if (confirm("¿Estás seguro de que deseas eliminar este usuario?")) {
                        await deleteUser(id);
                        loadUsers(); // Recargar categorías después de eliminar
                    }
                });
            });
            ...
            searchInput.addEventListener("input", function() {
                ...
                tableRows.forEach((row) => {
                    const userName = row.querySelector("td:nth-child(2) a")?.textContent.trim().toLowerCase();
                    const userUsername = row.querySelector("td:nth-child(4) strong")?.textContent.trim().toLowerCase();

                    if (userName.includes(searchText) || userUsername.includes(searchText)) {
                        row.style.display = "";
                    } else {
